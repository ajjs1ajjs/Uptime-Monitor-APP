        ...
        <div class="container">
            ...
            <div class="panel">
                <div class="panel-title" style="display: flex; justify-content: space-between; align-items: center;">
                    <span>🔔 Глобальні налаштування сповіщень</span>
                    <button class="btn-add-channel" onclick="openAddChannelModal()" style="padding: 8px 16px; font-size: 12px;">➕ Додати канал</button>
                </div>
